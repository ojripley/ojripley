      ...
      <div className={'bio-image-container'}>
        ...
        <div className='media-links'>
          ...
          <a href='https://www.paypal.me/ojripley' className='media-icon' target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-paypal" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" />
            ...
            <p className='media-caption'>
              Like the site? Learn something useful? Buy me a coffee! Pay my rent!
            </p>
          </a>
      </div>
