      ...
      <div className={props.text.img ? 'image-title-container' : ''}>
        ...
        {props.text.img ? 
          <>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="icon-tabler icon-tabler-arrows-minimize" width="32" height="32" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ff0000" fill="none" strokeLinecap="round" strokeLinejoin="round" id={`${props.text.subheader.toLowerCase().replace(/\s|\.|'+/g, '')}-close-icon`}>
         ...
         <div className='sub-section-link-container'>
          ...
          {props.text.subheader ?       
            <a className={`sub-section-header ${props.text.link ? 'sub-header-link' : ''}`} id={`${props.text.subheader.toLowerCase().replace(/\s|\.|'+/g, '')}-section`} href={props.text.link ? props.text.link : null} rel='noopener noreferrer' target='_blank'>
              ...
              {props.text.link ? 
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-arrow-right-circle" width="32" height="32" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" />
          ...
          {props.text.secondaryLink ?
            <a className='sub-section-secondary-link' href={props.text.secondaryLink.link} rel='noopener noreferrer' target='_blank'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-arrow-right-circle" width="20" height="20" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" />
                <circle cx="12" cy="12" r="9" />
                <line x1="16" y1="12" x2="8" y2="12" />
                <line x1="16" y1="12" x2="12" y2="16" />
